...
Assets.Code.Remote.Flat.Data = {
  ...
  PlayerHitData: 3,
  PlayerDeathData: 4,
  PlayerRespawnReqData: 5,
  PlayerRespawnAckData: 6,
  PointsChangedData: 7
};
 ...
 * @returns {number}
 */
Assets.Code.Remote.Flat.PlayerHitData.prototype.damage = function() {
  var offset = this.bb.__offset(this.bb_pos, 4);
  return offset ? this.bb.readInt32(this.bb_pos + offset) : 0;
};
 ...
 * @returns {number}
 */
Assets.Code.Remote.Flat.PlayerHitData.prototype.targetId = function() {
  var offset = this.bb.__offset(this.bb_pos, 6);
  return offset ? this.bb.readInt32(this.bb_pos + offset) : 0;
};
 ...
 * @returns {number}
 */
Assets.Code.Remote.Flat.PlayerHitData.prototype.shooterId = function() {
  var offset = this.bb.__offset(this.bb_pos, 8);
  return offset ? this.bb.readInt32(this.bb_pos + offset) : 0;
};
 ...
 * @param {number} damage
 */
Assets.Code.Remote.Flat.PlayerHitData.addDamage = function(builder, damage) {
 ...
 */
Assets.Code.Remote.Flat.PlayerHitData.addTargetId = function(builder, targetId) {
 ...
 */
Assets.Code.Remote.Flat.PlayerHitData.addShooterId = function(builder, shooterId) {
  builder.addFieldInt32(2, shooterId, 0);
};
