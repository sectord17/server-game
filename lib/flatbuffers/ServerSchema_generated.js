 ...
 * @returns {number}
 */
Assets.Code.Remote.LoginMsg.prototype.udpPort = function() {
 ...
 */
Assets.Code.Remote.LoginMsg.addUdpPort = function(builder, udpPort) {
  builder.addFieldInt32(2, udpPort, 0);
};
