...
module.exports = {
    ...
    gameData: {
        ...
        playerData(senderId) {
            ...
            return this._wrap(builder, senderId, playerData, GameAssets.Code.Remote.Flat.Data.PlayerData);
        },
        ...
        shootData(senderId) {
            ...
            return this._wrap(builder, senderId, shootData, GameAssets.Code.Remote.Flat.Data.ShootData);
        },
