 ...
 * @constructor
 */
Assets.Code.Remote.Flat.GameStart = function() {
  /**
   * @type {flatbuffers.ByteBuffer}
   */
  this.bb = null;
 ...
 * @param {number} i
 * @param {flatbuffers.ByteBuffer} bb
 * @returns {Assets.Code.Remote.Flat.GameStart}
 */
Assets.Code.Remote.Flat.GameStart.prototype.__init = function(i, bb) {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param {flatbuffers.ByteBuffer} bb
 * @param {Assets.Code.Remote.Flat.GameStart=} obj
 * @returns {Assets.Code.Remote.Flat.GameStart}
 */
Assets.Code.Remote.Flat.GameStart.getRootAsGameStart = function(bb, obj) {
  return (obj || new Assets.Code.Remote.Flat.GameStart).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};

/**
 * @param {flatbuffers.Builder} builder
 */
Assets.Code.Remote.Flat.GameStart.startGameStart = function(builder) {
 ...
 * @returns {flatbuffers.Offset}
 */
Assets.Code.Remote.Flat.GameStart.endGameStart = function(builder) {
  var offset = builder.endObject();
  return offset;
};
