...
class PlayerManager {
    ...
    authorize(token, name, connectionHandler) {
        return new Promise((resolve, reject) => {
            ...
            debug(`Player #${player.token} authorized`);
    ...
    connect(token, address, udpPort) {
        return new Promise((resolve, reject) => {
            ...
            winston.log('info', `Player #${player.id} <${address}:${udpPort}> connected`);
    ...
    disconnect(player) {
        ...
        winston.log('info', `Player #${player.id}<${player.communicationHandler.address}:${player.communicationHandler.udpPort}> disconnected`);
    }
